...
(define (problem original) 
  ...
  (:init
    ...
    (ubi-carga-bono B)
    (ubi-carga-bono C)
    (= (coste-recargar-bono) 4)
    (= (coste-recargar-billete) 1)
    (= (duracion-recargar-bono) 1)
    (= (duracion-recargar-billete) 1)
    (= (num-billetes-bono) 5)
    (= (num-billetes-individual) 1)
  ...
  (:metric minimize (- (+ (* 0.3 (total-time)) (* 0.7 (coste-recargas))) (beneficio-empresa)))
)
